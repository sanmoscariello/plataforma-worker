...
async function chequear() {
  ...
  console.log(`API_KEY presente: ${API_KEY ? 'SI (' + API_KEY.length + ' chars)' : 'NO!!!'}`);
  _logRssCount = 0; // resetear para loguear en cada ciclo
...
server.listen(PORT, () => {
  console.log('========================================');
  console.log('  WORKER VERSION 2 - CON LOGS RSS');
  console.log('========================================');
